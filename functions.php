               ...
               <div class="blog_inner">
                  ...
                  <div class="blog-info">
                     ...
                     <p><?php
                      ...
                      echo wp_trim_words( get_the_content(), 18, '...<a href="'.get_permalink().'">[Read More]</a>' );?></p>
                 	 <?php } else {?>
                 	 	<p><?php echo wp_trim_words( get_the_content(), 14, '...<a href="'.get_permalink().'">[Consulte Mais informação]</a>' );?></p>
                 	 <?php } ?>
                  </div>
               </div>
            </div>
